...
public class JobApplicationClassifier {
    ...
    public static OfferStatus classify(String subject, String body) {
        ...
        if (containsAny(combined, INTERVIEW_KEYWORDS)) return OfferStatus.INTERVIEW_INVITATION;
        if (containsAny(combined, REJECTED_KEYWORDS))  return OfferStatus.REJECTED;
        if (containsAny(combined, VIEWED_KEYWORDS))    return OfferStatus.APPLICATION_VIEWED;
        if (containsAny(combined, APPLIED_KEYWORDS))   return OfferStatus.APPLIED;
